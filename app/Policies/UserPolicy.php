...
class UserPolicy
{
    ...
    public function coordenar(User $user){
      return \Auth::user()->tipo_perfil == 'Coordenador';
    }

    public function gerenciar(User $user){
      return \Auth::user()->tipo_perfil == 'Associacao';
    }

    public function produzir(User $user){
      return \Auth::user()->tipo_perfil == 'Produtor';
    }

    public function primeiroAcesso(User $user){
