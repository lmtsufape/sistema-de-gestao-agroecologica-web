...
<div class="row extra-space">
    <div class="col-md-12 upper-div">
        <div class="especifies">
            ...
            <div class="row">
                <div class="col-md-10">
                    <h1 class="marker">Retificar reunião</h1>
                </div>
            </div>
        ...
        <div style="overflow: auto; height: 450px">
            <table class="table">
                ...
                <tbody>
                    ...
                    @if($reuniao_agendada->registrada)
                        <tr class='reuniao'>
                            <td class='nome_reuniao basic-space'><a class="cor-texto" href="{{route('user.coordenador.editarReuniao', ['id_reuniao' => $reuniao_agendada->id])}}">{{$reuniao_agendada->nome}}</a></td>
