            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    @if($reuniao_agendada->registrada == false)
                        <tr class='reuniao'>
                            <td class='nome_reuniao basic-space'><a class="cor-texto" href="{{route('user.coordenador.registrarReuniao', ['id_reuniao' => $reuniao_agendada->id])}}">{{$reuniao_agendada->nome}}</a></td>
